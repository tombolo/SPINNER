                    ...
                    <div className='header__menu-mobile-body-wrapper'>
                        <React.Fragment>
                                ...
                                >
                                    <div className='header__menu-mobile-stack'>
                                        ...
                                        <div className='header__socials'>
                                            ...
                                            <a
                                                href='https://whatsapp.com/channel/0029VbCP9qwEKyZJdalBkz1d'
                                                target='_blank'
                                                rel='noopener noreferrer'
                                                aria-label='TikTok'
                                            >
                            ...
                            <MobileDrawer.Body className={is_traders_hub_route || is_wallet_route ? 'no-padding' : ''}>
                                ...
                                <MobileDrawer.Item>
                                    <a href='' className='dc-menu-link' onClick={toggleDrawer}>
                                        <Icon icon={TradersHubIcon} className='dc-menu-link__icon' />
                                        <span className='dc-menu-link__text'>{localize('SPINNER TRADERS')}</span>
                                    </a>
                                </MobileDrawer.Item>
                                ...
                                {is_logged_in && (
                                    <MobileDrawer.Item
                                        onClick={oAuthLogout}
                                        className='dc-mobile-drawer__item header__menu-mobile-logout'
                                    >
