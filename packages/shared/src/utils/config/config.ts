...
export const domain_app_ids = {
    'smarttraderstool.com': 107711,
    'deriv.app': 107711,
    'app.deriv.com': 107711,
    'staging-app.deriv.com': 107711,
    'app.deriv.me': 107711,
    'staging-app.deriv.me': 107711,
    'app.deriv.be': 107711,
    'staging-app.deriv.be': 107711,
    'binary.com': 107711,
    'test-app.deriv.com': 107711,
    'royal-app-seven.vercel.app': 107711,
    'star-eight-ruby.vercel.app': 107711,
    'beleiver.vercel.app': 107711,
    'goon-puce.vercel.app': 107711,
};
...
export const getAppId = () => {
    ...
    if (platform && platform_app_ids[platform as keyof typeof platform_app_ids]) {
        ...
        app_id = is_bot ? 107711 : domain_app_ids[current_domain as keyof typeof domain_app_ids] || 107711;
